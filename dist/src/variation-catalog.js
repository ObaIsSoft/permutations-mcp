 ...
 */
export const SECTION_MODE_CATALOG = [
    {
        mode: "loud",
 ...
 */
export function generateVariationCSS() {
    return `
/* ── Section Mode System ────────────────────────────────────────────────── */
 ...
 */
export function getModeForSection(sequence, sectionIndex) {
 ...
 */
export function getSequenceModes(sequence) {
